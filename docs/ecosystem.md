...
| `react-dropzone`                     | `react-x11: uncaught error Error: react-x11: unknown element type <input>. …`                                                                                                                                                | built-in `useDropTarget` / `<box dropAccept onDrop>` — [events](events.md#drag-and-drop)       |
