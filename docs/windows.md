...
| `appId`                                            | the window's AppUserModelID and relaunch properties, which decide taskbar grouping and what pinning pins                                                                                                                                                        | bends — the identity exists, under another name                                                    |
