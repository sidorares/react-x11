...
| every other `_NET_WM_STATE`, and `fullscreen`                                                     | inert — the bridge has no zoom/miniaturize/fullscreen verbs yet (windowkit/appkit#15). `onStatesChange` reports what actually held |
