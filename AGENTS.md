...
- `npm run examples:{app,theming,container-queries,schedule,custom-layout,simple,simple-nojsx,xeyes,dashboard,tasks,menu,form,selection,widgets,windows,wm}`
